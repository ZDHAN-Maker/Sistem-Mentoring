...
import UploadForm from './component/UploadForm';  // Importing the UploadForm component
  ...
  return (
    <div className="p-8">
      ...
      <div className="space-y-4">
        {courses.map((course) => (
          <div className="flex justify-between items-center p-4 bg-gray-100 rounded-md shadow-md" key={course.id}>
